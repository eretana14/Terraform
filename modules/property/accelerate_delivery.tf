data "akamai_property_rules_builder" "eretana-terraform_rule_accelerate_delivery" {
  rules_v2025_10_16 {
    ...
    children = [
      data.akamai_property_rules_builder.eretana-terraform_rule_origin_connectivity.json,
      data.akamai_property_rules_builder.eretana-terraform_rule_protocol_optimizations.json,
      data.akamai_property_rules_builder.eretana-terraform_rule_prefetching.json,
      data.akamai_property_rules_builder.eretana-terraform_rule_adaptive_acceleration.json,
    ]
  }
}

data "akamai_property_rules_builder" "eretana-terraform_rule_origin_connectivity" {
  rules_v2025_10_16 {
...
data "akamai_property_rules_builder" "eretana-terraform_rule_protocol_optimizations" {
  rules_v2025_10_16 {
...
data "akamai_property_rules_builder" "eretana-terraform_rule_prefetching" {
  rules_v2025_10_16 {
    name                  = "Prefetching"
    comments              = "Instruct edge servers to retrieve embedded resources before the browser requests them."
    criteria_must_satisfy = "all"
    children = [
      data.akamai_property_rules_builder.eretana-terraform_rule_prefetching_objects.json,
      data.akamai_property_rules_builder.eretana-terraform_rule_prefetchable_objects.json,
    ]
  }
}

data "akamai_property_rules_builder" "eretana-terraform_rule_prefetching_objects" {
  rules_v2025_10_16 {
    ...
    children = [
      data.akamai_property_rules_builder.eretana-terraform_rule_bots.json,
    ]
  }
}

data "akamai_property_rules_builder" "eretana-terraform_rule_bots" {
  rules_v2025_10_16 {
    name                  = "Bots"
...
data "akamai_property_rules_builder" "eretana-terraform_rule_prefetchable_objects" {
  rules_v2025_10_16 {
...
data "akamai_property_rules_builder" "eretana-terraform_rule_adaptive_acceleration" {
  rules_v2025_10_16 {
