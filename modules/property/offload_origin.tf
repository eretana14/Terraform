data "akamai_property_rules_builder" "eretana-terraform_rule_offload_origin" {
  rules_v2025_10_16 {
    name                  = "Offload origin"
    ...
    children = [
      data.akamai_property_rules_builder.eretana-terraform_rule_css_and_java_script.json,
      data.akamai_property_rules_builder.eretana-terraform_rule_fonts.json,
      data.akamai_property_rules_builder.eretana-terraform_rule_images.json,
      data.akamai_property_rules_builder.eretana-terraform_rule_files.json,
      data.akamai_property_rules_builder.eretana-terraform_rule_other_static_objects.json,
      data.akamai_property_rules_builder.eretana-terraform_rule_html_pages.json,
      data.akamai_property_rules_builder.eretana-terraform_rule_redirects1.json,
      data.akamai_property_rules_builder.eretana-terraform_rule_post_responses.json,
      data.akamai_property_rules_builder.eretana-terraform_rule_uncacheable_objects.json,
    ]
  }
}

data "akamai_property_rules_builder" "eretana-terraform_rule_css_and_java_script" {
  rules_v2025_10_16 {
...
data "akamai_property_rules_builder" "eretana-terraform_rule_fonts" {
  rules_v2025_10_16 {
    name                  = "Fonts"
...
data "akamai_property_rules_builder" "eretana-terraform_rule_images" {
  rules_v2025_10_16 {
    name                  = "Images"
...
data "akamai_property_rules_builder" "eretana-terraform_rule_files" {
  rules_v2025_10_16 {
    name                  = "Files"
...
data "akamai_property_rules_builder" "eretana-terraform_rule_other_static_objects" {
  rules_v2025_10_16 {
...
data "akamai_property_rules_builder" "eretana-terraform_rule_html_pages" {
  rules_v2025_10_16 {
    name                  = "HTML pages"
...
data "akamai_property_rules_builder" "eretana-terraform_rule_redirects1" {
  rules_v2025_10_16 {
    name                  = "Redirects"
...
data "akamai_property_rules_builder" "eretana-terraform_rule_post_responses" {
  rules_v2025_10_16 {
    name                  = "POST responses"
...
data "akamai_property_rules_builder" "eretana-terraform_rule_uncacheable_objects" {
  rules_v2025_10_16 {
