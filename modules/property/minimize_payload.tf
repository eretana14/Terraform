data "akamai_property_rules_builder" "eretana-terraform_rule_minimize_payload" {
  rules_v2025_10_16 {
    ...
    children = [
      data.akamai_property_rules_builder.eretana-terraform_rule_compressible_objects.json,
    ]
  }
}

data "akamai_property_rules_builder" "eretana-terraform_rule_compressible_objects" {
  rules_v2025_10_16 {
