data "akamai_property_rules_builder" "eretana-terraform_rule_strengthen_security" {
  rules_v2025_10_16 {
    ...
    children = [
      data.akamai_property_rules_builder.eretana-terraform_rule_allowed_methods.json,
      data.akamai_property_rules_builder.eretana-terraform_rule_obfuscate_debug_info.json,
      data.akamai_property_rules_builder.eretana-terraform_rule_obfuscate_backend_info.json,
    ]
  }
}

data "akamai_property_rules_builder" "eretana-terraform_rule_allowed_methods" {
  rules_v2025_10_16 {
    ...
    children = [
      data.akamai_property_rules_builder.eretana-terraform_rule_post.json,
      data.akamai_property_rules_builder.eretana-terraform_rule_options.json,
      data.akamai_property_rules_builder.eretana-terraform_rule_put.json,
      data.akamai_property_rules_builder.eretana-terraform_rule_delete.json,
      data.akamai_property_rules_builder.eretana-terraform_rule_patch.json,
    ]
  }
}

data "akamai_property_rules_builder" "eretana-terraform_rule_post" {
  rules_v2025_10_16 {
    name                  = "POST"
...
data "akamai_property_rules_builder" "eretana-terraform_rule_options" {
  rules_v2025_10_16 {
    name                  = "OPTIONS"
...
data "akamai_property_rules_builder" "eretana-terraform_rule_put" {
  rules_v2025_10_16 {
    name                  = "PUT"
...
data "akamai_property_rules_builder" "eretana-terraform_rule_delete" {
  rules_v2025_10_16 {
    name                  = "DELETE"
...
data "akamai_property_rules_builder" "eretana-terraform_rule_patch" {
  rules_v2025_10_16 {
    name                  = "PATCH"
...
data "akamai_property_rules_builder" "eretana-terraform_rule_obfuscate_debug_info" {
  rules_v2025_10_16 {
...
data "akamai_property_rules_builder" "eretana-terraform_rule_obfuscate_backend_info" {
  rules_v2025_10_16 {
