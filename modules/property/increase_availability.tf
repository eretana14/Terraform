data "akamai_property_rules_builder" "eretana-terraform_rule_increase_availability" {
  rules_v2025_10_16 {
    ...
    children = [
      data.akamai_property_rules_builder.eretana-terraform_rule_simulate_failover.json,
      data.akamai_property_rules_builder.eretana-terraform_rule_site_failover.json,
      data.akamai_property_rules_builder.eretana-terraform_rule_origin_health.json,
      data.akamai_property_rules_builder.eretana-terraform_rule_script_management.json,
    ]
  }
}

data "akamai_property_rules_builder" "eretana-terraform_rule_simulate_failover" {
  rules_v2025_10_16 {
...
data "akamai_property_rules_builder" "eretana-terraform_rule_site_failover" {
  rules_v2025_10_16 {
    name                  = "Site failover"
...
data "akamai_property_rules_builder" "eretana-terraform_rule_origin_health" {
  rules_v2025_10_16 {
    name                  = "Origin health"
...
data "akamai_property_rules_builder" "eretana-terraform_rule_script_management" {
  rules_v2025_10_16 {
